...
<div class="mx-auto flex max-w-7xl items-center !px-6 lg:px-8 py-6">
  <div class="flex items-baseline align-baseline justify-between flex-1">
    ...
    <div class="flex gap-4">
      <a href="https://github.com/stacks-network/sbtc-bridge-web/issues" target="_blank" class="focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500/50 rounded-full">
      ...
      <a href="https://mobile.twitter.com/stacks" target="_blank" class="focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500/50 rounded-full">
