...
export async function fetchBitcoinTransactionHex(txId: string): Promise<any> {
	return await fetchTransactionHex(getConfig().VITE_MEMPOOL_API, txId);
}
 ...
 * @returns
 */
export function getParametersForProof(
	txIdNormal: string,
	txHex: string,
	block: any
): TxMinedParameters {
